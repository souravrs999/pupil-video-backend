...
parser.add_argument('-vp','--videoparameter',help='Video parameters. Example: "192, 192, 90". "Height, Width, FPS"', required=False)
...
def main(host, port, device, videosource, videoparameter):
    ...
    pupilbackend.setVideoCaptureParam(videosource=videosource, height=height, width=width, frame=frame)
